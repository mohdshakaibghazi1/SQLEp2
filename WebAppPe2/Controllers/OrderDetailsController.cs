...
using WebAppPe2.Data;
using WebAppPe2.Models;

namespace WebAppPe2.Controllers
{
    public class OrderDetailsController : Controller
    {
        private readonly pdbContext _context;

        public OrderDetailsController(pdbContext context)
        {
            _context = context;
        }
        ...
        {
            var pdbContext = _context.OrderDetail.Include(o => o.Order).Include(o => o.Product);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'pdbContext.OrderDetail'  is null.");
            }
            var orderDetail = await _context.OrderDetail.FindAsync(id);
            if (orderDetail != null)
            {
